...
SECRET_KEY = 'django-insecure-(a%h!ty139fhbgazgek$k_s5bwmxsyz(6wzj#l^7=&qvc=%vma'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],      # ← именно эта папка
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# URL, по которому будут «раздаваться» файлы
MEDIA_URL = '/media/'
